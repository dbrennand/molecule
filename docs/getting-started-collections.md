...
Use this page when the primary content under development is an Ansible collection. It covers collection-level testing with multiple Ansible content types, including roles, plugins, filters, and modules, along with shared test infrastructure.
