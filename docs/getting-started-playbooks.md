...
Use this page when the main question is whether a project’s playbooks work with its inventory and project configuration. It covers the project generated by `ansible-creator init playbook`, its root playbooks and inventory, and the Molecule scenarios added to exercise them.
